...
activities = {
    ...
    "Photography Workshop": {
        "description": "Learn photography basics and participate in photo walks",
    ...
    "Science Olympiad": {
        "description": "Participate in science challenges and competitions across various disciplines",
        "schedule": "Wednesdays, 3:30 PM - 5:00 PM",
        "max_participants": 20,
